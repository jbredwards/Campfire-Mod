...
{
    public static int getResultDyeColor(int baseColor, @Nonnull List<EnumDyeColor> dyes) {
    ...
    public boolean isDyeableTarget(@Nonnull ItemStack stack) {
        return Block.getBlockFromItem(stack.getItem()) instanceof BlockColorEmitting;
    }
