...
public final class ModelCampfireInvWrapper implements IModel
{
    ...
    static class BakedModel extends BakedModelWrapper<IBakedModel>
    {
        @Nonnull
        ...
        public ItemOverrideList getOverrides() {
            ...
            return new ItemOverrideList(overrides.getOverrides()) {
                ...
                public IBakedModel handleItemState(@Nonnull IBakedModel originalModelIn, @Nonnull ItemStack stack, @Nullable World world, @Nullable EntityLivingBase entity) {
                    return createOverrideModel(overrides.handleItemState(originalModel, stack, world, entity), stack);
                }
            };
        }

        @Nonnull
        IBakedModel createOverrideModel(@Nonnull final IBakedModel original, @Nonnull final ItemStack stack) { return new BakedModel(original, cameraTransforms); }
    }
